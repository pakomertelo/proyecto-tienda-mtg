            ...
            <table class="tabla-productos">
                ...
                <tbody>
                    ...
                    foreach ($cartas as $carta) {
                        ...
                        $yaVoto = !empty($votosUsuario[$carta['id']]);
                    ?>
                    <tr>
                        <td>
                            <img src="../img/<?php echo htmlspecialchars($carta['imagen']); ?>"
                                alt="<?php echo htmlspecialchars($carta['nombre']); ?>" width="80">
                        </td>
                        ...
                        <td>
                            <p id="valoracion-<?php echo $carta['id']; ?>" class="valoracion-texto">
                                <?php echo htmlspecialchars(textoValoracion($resumen)); ?>
                            </p>

                            <form class="form-voto" data-id="<?php echo $carta['id']; ?>">
                                <select name="cantidad" <?php echo $yaVoto ? 'disabled' : ''; ?>>
                                ...
                                <button type="submit" <?php echo $yaVoto ? 'disabled' : ''; ?>>Votar</button>
                            </form>
                        </td>
                        <td>
                            <button type="button" class="btn-carrito"
                                data-nombre="<?php echo htmlspecialchars($carta['nombre']); ?>"
                                data-precio="<?php echo $carta['precio']; ?>">
                                <?php echo $t['anadir_carrito']; ?>
                            </button>
                        </td>
                        <td>
                            <form action="anadirDeseo.php" method="post">
                                <input type="hidden" name="nombre"
                                    value="<?php echo htmlspecialchars($carta['nombre']); ?>">
